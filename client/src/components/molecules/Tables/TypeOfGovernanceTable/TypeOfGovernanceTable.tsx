...
const CONTENT_TABLE: ContentTypeOfGovernanceTable[] = [
  {
    ...
    governance: "Broad",
    relevantBodies:
      "All (led by Governance Authority & DS4SSCC members representative committee)",
  },
  {
    action:
  ...
  },
  {
    ...
    governance: "Mixed",
    relevantBodies:
      "Governance board, Operational Committee, DS4SSCC member representative committee",
  },
  {
    action: "Enforcement",
    governance: "Mixed",
  ...
  },
  {
    ...
    governance: "Narrow",
    relevantBodies:
      "Data & Technology committee, DS4SSCC user representative board. Advisory boards",
  },
  {
  ...
  ({}: PropsWithChildren<TypeOfGovernanceTableProps>) => {
    return (
      <Table className={Styles.TypeOfGovernanceTable}>
        <caption>Table 8: Type of governance and relevant bodies</caption>
