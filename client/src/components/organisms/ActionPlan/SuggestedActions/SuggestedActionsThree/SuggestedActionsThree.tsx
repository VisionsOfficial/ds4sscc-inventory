...
import Styles from "./SuggestedActionsThree.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type SuggestedActionsThreeProps = {};

export const SuggestedActionsThree =
  ({}: PropsWithChildren<SuggestedActionsThreeProps>) => {
    return (
      <Card className={Styles.SuggestedActionsThree}>
        <h3>Lorem ipsum Proving Suggested Actions</h3>
        <p>
