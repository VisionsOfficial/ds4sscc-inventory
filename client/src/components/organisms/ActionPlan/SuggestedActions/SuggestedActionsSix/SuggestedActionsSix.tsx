...
import Styles from "./SuggestedActionsSix.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type SuggestedActionsSixProps = {};

export const SuggestedActionsSix =
  ({}: PropsWithChildren<SuggestedActionsSixProps>) => {
    return (
      <Card className={Styles.SuggestedActionsSix}>
        <h3>Lorem ipsum Complete Suggested Actions</h3>
        <p>
