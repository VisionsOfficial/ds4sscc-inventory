...
import Styles from "./SuggestedActionsFour.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type SuggestedActionsFourProps = {};

export const SuggestedActionsFour =
  ({}: PropsWithChildren<SuggestedActionsFourProps>) => {
    return (
      <Card className={Styles.SuggestedActionsFour}>
        <h3>Lorem ipsum Organizing Suggested Actions</h3>
        <p>
