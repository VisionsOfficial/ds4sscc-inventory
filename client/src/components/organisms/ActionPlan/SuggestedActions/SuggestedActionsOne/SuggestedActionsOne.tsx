...
import Styles from "./SuggestedActionsOne.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type SuggestedActionsOneProps = {};

export const SuggestedActionsOne =
  ({}: PropsWithChildren<SuggestedActionsOneProps>) => {
    return (
      <Card className={Styles.SuggestedActionsOne}>
        <h3>Lorem ipsum Preliminary Suggested Actions</h3>
        <p>
