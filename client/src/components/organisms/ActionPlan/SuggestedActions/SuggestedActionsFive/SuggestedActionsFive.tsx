...
import Styles from "./SuggestedActionsFive.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type SuggestedActionsFiveProps = {};

export const SuggestedActionsFive =
  ({}: PropsWithChildren<SuggestedActionsFiveProps>) => {
    return (
      <Card className={Styles.SuggestedActionsFive}>
        <h3>Lorem ipsum Increasing Suggested Actions</h3>
        <p>
