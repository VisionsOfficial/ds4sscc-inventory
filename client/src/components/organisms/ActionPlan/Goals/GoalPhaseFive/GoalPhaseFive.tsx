...
import Styles from "./GoalPhaseFive.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type GoalPhaseFiveProps = {};

export const GoalPhaseFive = ({}: PropsWithChildren<GoalPhaseFiveProps>) => {
  return (
    <Card className={Styles.GoalPhaseFive}>
      <h3>Lorem ipsum Increasing Goal</h3>
      <p>
