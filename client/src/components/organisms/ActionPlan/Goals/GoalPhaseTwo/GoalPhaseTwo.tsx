...
import Styles from "./GoalPhaseTwo.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type GoalPhaseTwoProps = {};

export const GoalPhaseTwo = ({}: PropsWithChildren<GoalPhaseTwoProps>) => {
  return (
    <Card className={Styles.GoalPhaseTwo}>
      <h3>Lorem ipsum Development Goal</h3>
      <p>
