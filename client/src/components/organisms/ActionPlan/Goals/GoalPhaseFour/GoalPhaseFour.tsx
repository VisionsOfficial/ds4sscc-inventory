...
import Styles from "./GoalPhaseFour.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type GoalPhaseFourProps = {};

export const GoalPhaseFour = ({}: PropsWithChildren<GoalPhaseFourProps>) => {
  return (
    <Card className={Styles.GoalPhaseFour}>
      <h3>Lorem ipsum Organizing Goal</h3>
      <p>
