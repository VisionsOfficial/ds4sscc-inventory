...
import Styles from "./GoalPhaseOne.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type GoalPhaseOneProps = {};

export const GoalPhaseOne = ({}: PropsWithChildren<GoalPhaseOneProps>) => {
  return (
    <Card className={Styles.GoalPhaseOne}>
      <h3>Lorem ipsum Preliminary Goal</h3>
      <p>
