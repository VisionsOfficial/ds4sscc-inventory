...
import Styles from "./GoalPhaseSix.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type GoalPhaseSixProps = {};

export const GoalPhaseSix = ({}: PropsWithChildren<GoalPhaseSixProps>) => {
  return (
    <Card className={Styles.GoalPhaseSix}>
      <h3>Lorem ipsum Complete Goal</h3>
      <p>
