...
import Styles from "./GoalPhaseThree.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type GoalPhaseThreeProps = {};

export const GoalPhaseThree = ({}: PropsWithChildren<GoalPhaseThreeProps>) => {
  return (
    <Card className={Styles.GoalPhaseThree}>
      <h3>Lorem ipsum Proving Goal</h3>
      <p>
