...
import Styles from "./ProcessPhaseFive.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type ProcessPhaseFiveProps = {};

export const ProcessPhaseFive =
  ({}: PropsWithChildren<ProcessPhaseFiveProps>) => {
    return (
      <Card className={Styles.ProcessPhaseFive}>
        <h3>Lorem ipsum Increasing Process</h3>
        <p>
