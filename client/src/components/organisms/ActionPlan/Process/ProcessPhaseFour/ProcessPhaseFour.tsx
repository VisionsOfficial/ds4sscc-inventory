...
import Styles from "./ProcessPhaseFour.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type ProcessPhaseFourProps = {};

export const ProcessPhaseFour =
  ({}: PropsWithChildren<ProcessPhaseFourProps>) => {
    return (
      <Card className={Styles.ProcessPhaseFour}>
        <h3>Lorem ipsum Organizing Process</h3>
        <p>
