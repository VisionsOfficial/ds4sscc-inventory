...
import Styles from "./ProcessPhaseOne.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type ProcessPhaseOneProps = {};

export const ProcessPhaseOne =
  ({}: PropsWithChildren<ProcessPhaseOneProps>) => {
    return (
      <Card className={Styles.ProcessPhaseOne}>
        <h3>Lorem ipsum Preliminary Process</h3>
        <p>
