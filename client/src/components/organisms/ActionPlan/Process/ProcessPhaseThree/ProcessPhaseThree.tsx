...
import Styles from "./ProcessPhaseThree.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type ProcessPhaseThreeProps = {};

export const ProcessPhaseThree =
  ({}: PropsWithChildren<ProcessPhaseThreeProps>) => {
    return (
      <Card className={Styles.ProcessPhaseThree}>
        <h3>Lorem ipsum Proving Process</h3>
        <p>
