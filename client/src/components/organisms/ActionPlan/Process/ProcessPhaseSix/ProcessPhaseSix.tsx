...
import Styles from "./ProcessPhaseSix.module.scss";
import { Card } from "../../../../atoms/Card/Card";

type ProcessPhaseSixProps = {};

export const ProcessPhaseSix =
  ({}: PropsWithChildren<ProcessPhaseSixProps>) => {
    return (
      <Card className={Styles.ProcessPhaseSix}>
        <h3>Lorem ipsum Complete Process</h3>
        <p>
